    ...
    cc.GameView = cc.Class({
        ...
        sendRequestOnHub: function (method) {
            switch (method) {
                case cc.MethodHubName.ENTER_LOBBY:
                    ...
                    break;
                case cc.MethodHubName.UPDATE_DAILY_ONLINE_QUEST:
                    this.portalHub.sentUpdateDailyOnlineQuest();
                    break;
        ...
        onHubOpen: function (obj) {
            ...
            this.schedule(function() {
                this.sendRequestOnHub(cc.MethodHubName.UPDATE_DAILY_ONLINE_QUEST)
            }, 60);
        },
