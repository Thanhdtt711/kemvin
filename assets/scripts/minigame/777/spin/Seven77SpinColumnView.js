...
(function () {
    cc.Seven77SpinColumnView = cc.Class({
        ...
        randomIcon2: function (indexIcon) {
            var ran = Math.floor((Math.random() * this.totalIcons));
            this.skeletonIcons[parseInt(indexIcon.toString())].skeletonData = this.skeletonDataIcons[ran];
            this.skeletonIcons[parseInt(indexIcon.toString())].getComponent(sp.Skeleton).setAnimation(0,'animation',true);
        ...
        setData: function () {
            ...
            for (var i = 1; i <= 3; i++) {
                ...
                this.skeletonIcons[i].getComponent(sp.Skeleton).setAnimation(0,'animation',true);
