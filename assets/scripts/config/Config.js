...
(function () {
    ...
    var GROUP_FB_B1 = 'http://fbhotro.kemabc.xyz';
    var FANPAGE_FB_B1 = 'http://fbhotro.kemabc.xyz';

    var GROUP_FB_B2 = 'http://fbhotro.kemabc.xyz';
    var FANPAGE_FB_B2 = 'http://fbhotro.kemabc.xyz';

    var GROUP_FB_B3 = 'http://fbhotro.kemabc.xyz';
    var FANPAGE_FB_B3 = 'http://fbhotro.kemabc.xyz';

    var GROUP_FB_B4 = 'http://fbhotro.kemabc.xyz';
    var FANPAGE_FB_B4 = 'http://fbhotro.kemabc.xyz';

    var TELE_HOTRO = 'http://telehotro.kemabc.xyz';
    var TAI_OTP_X6 = 'https://tai.kemabc.xyz/';

    var DOWNLOAD_URL_B1 = 'https://tai.kemabc.xyz/';
    var DOWNLOAD_URL_B2 = 'https://tai.kemabc.xyz/';
    var DOWNLOAD_URL_B3 = 'https://tai.kemabc.xyz/';
    var DOWNLOAD_URL_B4 = 'https://tai.kemabc.xyz/';

    var OLD_URLs = []; //bigbom.win
    var NEW_URLs = [];

    //FAKE 2
    var GROUP_FB_B1_F = 'http://telehotro.kemabc.xyz';
    var FANPAGE_FB_B1_F = 'http://fbhotro.kemabc.xyz';

    var GROUP_FB_B2_F = 'http://www.facebook.com/';
    var FANPAGE_FB_B2_F = 'http://www.facebook.com/';

    var GROUP_FB_B3_F = 'http://www.facebook.com/';
    var FANPAGE_FB_B3_F = 'http://www.facebook.com/';

    var TELE_URL = 'http://telebot.kemabc.xyz'//'http://t.me/kemvin_bot'//'http://telebot.kemabc.xyz';//'http://t.me/otpsieusoc_bot';
    var TELEBOT_URL = 'http://t.me/kemvin_bot'
    var FAKE_URLs = [];
    ...
    Config = (function () {
        ...
        Config.prototype.getTeleUrl = function () {
            return TELE_URL;
        };
        Config.prototype.getTeleBotUrl = function () {
            return TELEBOT_URL;
        };
