    ...
    cc.ChatItem = cc.Class({
        ...
        formatChatUser: function (chatItem) {//
            ...
            if (chatItem.ad) {//
                ...
                if(cc.LoginController.getInstance().getNickname() == chatItem.n) {
                    return '<color=#00CCFF>' + chatItem.n + ': </color>' + chatItem.c;
                } else {
                    return '<color=#E6B44B>' + chatItem.n + ': </color>' + chatItem.c;
