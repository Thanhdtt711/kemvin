...
(function () {
    cc.ChatView = cc.Class({
        ...
        showChat: function () {
            ...
            if (typeof this.listChat === 'undefined') {
                var content = '';
        ...
        addChatContent: function (message) {
            // console.log('addChatContent', message)
            if (message.ad) {
...
//
        ...
        onHubMessage: function (response) {
            // console.log('onHubMessage', response)
        ...
        editingReturn: function () {
            // console.log('this.editBoxChat.string', this.editBoxChat.string)
