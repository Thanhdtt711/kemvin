...
(function () {
    ...
    LobbyJackpotController = (function () {
        ...
        LobbyJackpotController.prototype.onGetJackpotShootFishResponse = function (xJackpotResponse) {
            return this.lobbyJackpotView.onGetJackpotShootFishResponse(xJackpotResponse);
        };
