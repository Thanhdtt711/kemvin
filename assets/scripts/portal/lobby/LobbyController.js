...
(function () {
    ...
    LobbyController = (function () {
        ...
        LobbyController.prototype.destroyDailyRewardView = function () {
            return this.lobbyView.destroyDailyRewardView();
        };

        LobbyController.prototype.destroyDailyMissionView = function () {
            return this.lobbyView.destroyDailyMissionView();
        };
        ...
        LobbyController.prototype.createShopView = function (startTab) {
            ...
            if (startTab === cc.ShopTab.REDEEM_REWARD) {
        ...
        LobbyController.prototype.createDailyRewardView = function () {
            return this.lobbyView.createDailyRewardView();
        };

        LobbyController.prototype.createDailyMissionView = function () {
            return this.lobbyView.createDailyMissionView();
        };
