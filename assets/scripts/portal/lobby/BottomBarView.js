...
(function () {
    cc.BottomBarView = cc.Class({
        ...
        dailyRewardClicked: function () {
            if (cc.LoginController.getInstance().checkLogin()) {
                cc.LobbyController.getInstance().createDailyRewardView();
                cc.DDNA.getInstance().uiInteraction(cc.DDNAUILocation.PORTAL, 'DAILYREWARD', cc.DDNAUIType.BUTTON);
            }
        },

        dailyMissionClicked: function () {
            if (cc.LoginController.getInstance().checkLogin()) {
                cc.LobbyController.getInstance().createDailyMissionView();
                cc.DDNA.getInstance().uiInteraction(cc.DDNAUILocation.PORTAL, 'DAILYRMISSION', cc.DDNAUIType.BUTTON);
            }
        },
