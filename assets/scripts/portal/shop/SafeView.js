...
(function () {
    cc.SafeView = cc.Class({
        ...
        onLoad: function () {
            ...
            this.editBoxFreezeValue.placeholder = 'Số ' + cc.Config.getInstance().currency() + ' đóng băng';
            this.editBoxOpenValue.placeholder = 'Số ' + cc.Config.getInstance().currency() + ' mở băng';
        },
        ...
        openClicked: function () {
            this.amount = cc.Tool.getInstance().removeDot(this.editBoxOpenValue.string);
