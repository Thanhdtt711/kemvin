...
(function () {
    cc.RedeemMomoView = cc.Class({
        ...
        onLoad: function () {
            ...
            this.nodeBaoTri.active = false;
            this.isTimer = false;
            this.timer = 0;
            this.timePerGetOTP = 120;
            this.updateInterval = 1;
            this.updateTimer = 0;
            this.lbSelectedBankCode = "MOMO";
            this.lbSelectedBank.string = "MOMO";

            this.otpType = cc.OTPType.TELEGRAM;
            //this.lbTestUpdateScript.string = "UPDATE MOI NHAghjkghjkghjkghjkgT"
            ...
            var getListRedeemMomoCommand = new cc.GetListRedeemMomoCommand;
            getListRedeemMomoCommand.execute(this);
