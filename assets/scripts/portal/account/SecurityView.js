...
(function () {
    cc.SecurityView = cc.Class({
        ...
        properties: {
            ...
            nodeButtonTelegram: cc.Node, //bat len khi chua co sdt thay cho lbPhoneNumber
        ...
        onLoad: function () {
            ...
            this.lbOTPDeletePhone.string = 'TELEGRAM';
        ...
        init: function () {
            ...
            //     this.lbTeleID.node.active = false;
            ...
            if (cc.Config.getInstance().getDomainVK().includes(netConfig.HOST)) {
                ...
                this.lbOTPCancelLoginSecurity.string = 'SMS';
                ...
                if (loginResponse.TeleID === 0) {
                    ...
                    this.otpType = cc.OTPType.SMS;
                    this.lbOTPCancelLoginSecurity.string = 'SMS';
                    this.lbOTPTypeNoPhone.string = 'SMS';
                } else {
                    this.otpType = cc.OTPType.TELEGRAM;
                    this.lbOTPCancelLoginSecurity.string = 'Telegram';
                    this.lbOTPTypeNoPhone.string = 'Telegram';
                }
            }
        },
        ...
        onUpdatePhoneResponse: function (response) {
            ...
            this.loginResponse.PhoneNumber = response.Phone;
        ...
        selectOTPDeletePhoneEvent: function(event, data) {
            this.otpType = data.toString() === 'Telegram' ? cc.OTPType.TELEGRAM : cc.OTPType.SMS;
        ...
        updateTelegramClicked: function () {
            var loginResponse = cc.LoginController.getInstance().getLoginResponse();
            cc.sys.openURL(cc.Config.getInstance().getTeleBotUrl()+'?start='+loginResponse.AccountID);
            return;
        },
        ...
        getOTPDeletePhoneClicked: function () {
            this.activeTimeOTPButton();
            var getOTPCommand = new cc.GetOTPCommand;
            getOTPCommand.execute(this, '', cc.OTPType.SMS);
        },
